        ...
        <div className="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
          <div className="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
            ...
            >
              ...
              Florushers Edge<span className="text-pink-500">.</span>
            </span>
              </span>
            </a>
            ...
            <div className="flex flex-col w-full text-gray-700">
              ...
              <div className="flex justify-start pl-4 mt-2">
                ...
                >
                  ...
                  <a target="_blank" href="https://icons8.com/icon/3hpGCFYCBrFJ/student-male">Student Male icon by Icons8</a>
                  <a target="_blank" href="https://icons8.com/icon/dfOUuAjJOmnr/waiter">Waiter icon by Icons8</a>
                  <a target="_blank" href="https://icons8.com/icon/bdtrWdwn9cK5/clients">Clients icon by Icons8</a>
              </div>
            </div>
          </div>
        </div>
        <div className="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">
  © {new Date().getFullYear()} Florishers Edge. All rights reserved.
</div>
