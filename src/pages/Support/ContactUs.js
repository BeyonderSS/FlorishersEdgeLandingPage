...
const ContactUs = ({ pageInfo = {} }) => {
    const { register, handleSubmit } = useForm();
    const onSubmit = (formData) => {
        window.location.href = `mailto:Educationparasmani@gmail.com?subject=${formData.subject}&body=Hi, my name is ${formData.name},${formData.message} (${formData.email})`;
    };
                ...
                <section className="min-h-screen">
                    ...
                    >
                        <g transform="translate(960,440) scale(1,1) translate(-960,-440)">
                            ...
                            >
                                <stop
                                    stopColor="hsl(217, 88%, 33.7%)"
                                    offset={0}
                                />
                                <stop
                                    stopColor="hsl(217, 88%, 75.1%)"
                                    offset={1}
                                />
                            </linearGradient>
                            <path
